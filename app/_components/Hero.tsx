		...
		<Section className='flex max-md:flex-col items-start gap-4'>
			<div className='flex-[3] flex flex-col gap-2'>
				...
				<p className='text-base mt-4'>
					...
					ou Gitlab 
					<Link
						href='https://gitlab.com/vanessa-berardozzi'
						target='_blank'
					>
						<Code className='inline-flex items-baseline gap-2 hover:bg-accent '>
							{' '}
			...
			<div className='flex-[1] max-md m-auto ml-auto'>
				<img
					src='https://media.licdn.com/dms/image/v2/D5603AQFI6NyTbI3G7Q/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1719497356641?e=1738800000&v=beta&t=7GWcGSRczgOcChI94bcC-Zv2vZwKDKQeH1KUjAfk3VA'
					height={250}
					width={250}
